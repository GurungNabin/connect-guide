        ...
        child: FutureBuilder<BusinessModel>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return const Center(child: Text('Failed to load business data'));
              ...
              final recommendedBusinesses = businesses.skip(7).take(5).toList();
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                final business = nearYouBusinesses[index];
                                return CustomInfoCard(
                                  title: business.category ?? 'No category',
                                  name: business.name ?? 'No name',
                                  address: business.location?.toString() ??
                                      'No address',
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                final business = hotInTownBusinesses[index];
                                return CustomInfoCard(
                                  title: business.category ?? 'No category',
                                  name: business.name ?? 'No name',
                                  address: business.location?.toString() ??
